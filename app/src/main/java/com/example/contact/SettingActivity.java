...
public class SettingActivity extends AppCompatActivity {
    ...
    public void deleteAllContacts(View view){
        ...
        Toast.makeText(SettingActivity.this, "All Contacts Deleted", Toast.LENGTH_SHORT).show();
    }

    public void deleteCallLogs(View view){
        DatabaseHandler db = new DatabaseHandler(this);
        db.deleteAllCallLogs();
        Toast.makeText(SettingActivity.this, "All Call Logs deleted", Toast.LENGTH_SHORT).show();
    }
}
